...
*ProgramsApi* | [**getProgramPlatformLocale**](docs/Api/ProgramsApi.md#getprogramplatformlocale) | **GET** /programs/{id_program}/platforms/{id_platform}/locales/{id_locale} | Get the list of the downloads stats for a given program platform locale
