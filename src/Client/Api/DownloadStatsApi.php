...
class DownloadStatsApi
{
    ...
    {
        $this->getDownloadStatWithHttpInfo($id);
    }
    ...
    {
        $this->getDownloadStatsWithHttpInfo($accept_language, $app_id, $country, $date, $page, $per_page);
    }
     ...
     *
     * @param  string $accept_language Locale (required)
     * @param  \Softonic\DownloadStatsApiSdk\Client\Model\DownloadStats $download_stats download_stats (optional)
     *
     * @throws \Softonic\DownloadStatsApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postDownloadStats($accept_language, $download_stats = null)
    {
        $this->postDownloadStatsWithHttpInfo($accept_language, $download_stats);
    }
     ...
     *
     * @param  string $accept_language Locale (required)
     * @param  \Softonic\DownloadStatsApiSdk\Client\Model\DownloadStats $download_stats (optional)
     *
     * @throws \Softonic\DownloadStatsApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postDownloadStatsWithHttpInfo($accept_language, $download_stats = null)
    {
        $returnType = '';
        $request = $this->postDownloadStatsRequest($accept_language, $download_stats);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postDownloadStatsAsync($accept_language, $download_stats = null)
    {
        return $this->postDownloadStatsAsyncWithHttpInfo($accept_language, $download_stats)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postDownloadStatsAsyncWithHttpInfo($accept_language, $download_stats = null)
    {
        $returnType = '';
        $request = $this->postDownloadStatsRequest($accept_language, $download_stats);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postDownloadStatsRequest($accept_language, $download_stats = null)
    {
        // verify the required parameter 'accept_language' is set
        if ($accept_language === null) {
            throw new \InvalidArgumentException(
        ...
        // body params
        $_tempBody = null;
        if (isset($download_stats)) {
            $_tempBody = $download_stats;
        }
     ...
     * @return void
     */
    public function putDownloadStats($id, $accept_language, $download_stats = null)
    {
        $this->putDownloadStatsWithHttpInfo($id, $accept_language, $download_stats);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putDownloadStatsWithHttpInfo($id, $accept_language, $download_stats = null)
    {
        $returnType = '';
        $request = $this->putDownloadStatsRequest($id, $accept_language, $download_stats);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putDownloadStatsAsync($id, $accept_language, $download_stats = null)
    {
        return $this->putDownloadStatsAsyncWithHttpInfo($id, $accept_language, $download_stats)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putDownloadStatsAsyncWithHttpInfo($id, $accept_language, $download_stats = null)
    {
        $returnType = '';
        $request = $this->putDownloadStatsRequest($id, $accept_language, $download_stats);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putDownloadStatsRequest($id, $accept_language, $download_stats = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException(
