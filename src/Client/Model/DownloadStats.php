...
class DownloadStats implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    public function valid()
    {
        ...
        if ($this->offsetGet('language') === null) {
            return false;
        }
    ...
    public function validProperties()
    {
        ...
        if (array_key_exists('language', $this->container) && $this->container['language'] === null) {
            return false;
        }
    ...
    {
        return array_key_exists('language', $this->container) ? $this->container['language'] : null;
    }
