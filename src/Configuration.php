...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://download-stats-v1.eu-west.sftapi.com';
     ...
     * @var string
     */
    protected $userAgent = 'Swagger-Codegen/1.18.0/php';
    ...
    {
        $report  = 'PHP SDK (Softonic\DownloadStatsApiSdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 1.72.0' . PHP_EOL;
